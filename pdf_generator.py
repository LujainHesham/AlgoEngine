...
ALGORITHM_CATEGORIES = {
    ...
    # New algorithms added in v2
    'knapsack_greedy': {'name': 'Greedy (Approx)', 'category': 'greedy', 'symbol': '🎯'},
    'prim_mst_greedy': {'name': 'Greedy (Prim)', 'category': 'greedy', 'symbol': '🎯'},
    'bubble_sort_bf': {'name': 'Brute Force (Bubble)', 'category': 'brute_force', 'symbol': '⚠'},
    'quick_sort_bf': {'name': 'Quick Sort', 'category': 'divide_conquer', 'symbol': '⚡'},
    'linear_search_bf': {'name': 'Linear Search', 'category': 'brute_force', 'symbol': '⚠'},
    'naive_matrix_multiplication_bf': {'name': 'Naive Matrix Mult', 'category': 'brute_force', 'symbol': '⚠'},
    'linear_exponentiation_bf': {'name': 'Linear Exponentiation', 'category': 'brute_force', 'symbol': '⚠'},
    'scheduling_bruteforce': {'name': 'Scheduling Brute Force', 'category': 'brute_force', 'symbol': '⚠'},
    'sequence_alignment_bruteforce': {'name': 'Alignment Brute Force', 'category': 'brute_force', 'symbol': '⚠'},
    'subset_sum_bruteforce': {'name': 'Subset Sum BF', 'category': 'brute_force', 'symbol': '⚠'},
    'fractional_knapsack_naive_greedy': {'name': 'Naive Greedy', 'category': 'greedy', 'symbol': '🎯'},
}
